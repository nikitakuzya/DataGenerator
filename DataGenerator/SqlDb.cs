...
namespace DataGenerator
{
    class SqlDb
    {
            ...
            public SqlDb()
            {
                if (Default.DB_useRegSettings)
                {
                    ...
                    if (regKey64 != null)
                    {
                        ...
                        Password = Default.DB_usePasswordCrypt
                ...
                else
                {
                    ...
                    DataSource = Default.DB_DataSource;
                    UserId = Default.DB_UserID;
                    Password = Default.DB_usePasswordCrypt ? Crypt.GetPassword(Default.DB_Password) : Default.DB_Password;
                    Password = Default.DB_Password;
                    InitialCatalog = Default.DB_InitialCatalog;
                    TimeOut = "2";
                }
            }
            ...
            public void Open()
            {
                ...
                {
                //"Provider=" + Provider + ";" +
                    ConnectionString = "Persist Security Info=" + Convert.ToString(PersistSecurityInfo) + ";" +
                                       "Integrated Security=" + Convert.ToString(IntegratedSecurityInfo) + ";" +
                                       "User ID=" + UserId + ";" +
                                       "Password=" + Password + ";" +
            ...
            private void Connection_InfoMessage(object sender, SqlInfoMessageEventArgs args)
            {
                List<string> messList = new List<string>();
                messList.Add(args.Source + " : " + args.Message);
                messList.AddRange(from SqlError err in args.Errors select err.Message);
            ...
            public bool WriteOperMess_Accounts(uint iUserId, string strLogin, string strPassword, string strUserName, uint iGroupId, string strJob, string strFirm, uint iIsActive)
            {
                ...
                if ((strLogin != null) && (strPassword != null) && (strUserName != null) && (strJob != null) && (strFirm != null))
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("UserID",SqlDbType.Int).Value = iUserId;
                        Command.Parameters.Add("Login", SqlDbType.NVarChar).Value = strLogin;
                        Command.Parameters.Add("Password", SqlDbType.NVarChar).Value = strPassword;
                        Command.Parameters.Add("UserName", SqlDbType.NVarChar).Value = strUserName;
                        Command.Parameters.Add("GroupID",SqlDbType.Int).Value = iGroupId;
                        Command.Parameters.Add("Job", SqlDbType.NVarChar).Value = strJob;
                        Command.Parameters.Add("Firm", SqlDbType.NVarChar).Value = strFirm;
                        Command.Parameters.Add("isActive",SqlDbType.Int).Value = iIsActive;
            ...
            public bool WriteOperMess_Accounts_2(uint iUserId, string strLogin, string strPassword, string strUserName, uint iGroupId, string strJob, string strFirm, uint iIsActive, string strOldPassword, string strTimePasswordChange, string strPassword1, string strPassword2, string strPassword3, string strPassword4)
            {
                ...
                if ((strLogin != null) && (strPassword != null) && (strUserName != null) && (strJob != null) && (strFirm != null) && (strOldPassword != null) && (strTimePasswordChange != null) && (strPassword1 != null) && (strPassword2 != null) && (strPassword3 != null) && (strPassword4 != null))
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("UserID",SqlDbType.Int).Value = iUserId;
                        Command.Parameters.Add("Login", SqlDbType.NVarChar).Value = strLogin;
                        Command.Parameters.Add("Password", SqlDbType.NVarChar).Value = strPassword != "" ? strPassword : null;
                        Command.Parameters.Add("UserName", SqlDbType.NVarChar).Value = strUserName;
                        Command.Parameters.Add("GroupID",SqlDbType.Int).Value = iGroupId;
                        Command.Parameters.Add("Job", SqlDbType.NVarChar).Value = strJob;
                        Command.Parameters.Add("Firm", SqlDbType.NVarChar).Value = strFirm;
                        Command.Parameters.Add("isActive",SqlDbType.Int).Value = iIsActive;
                        Command.Parameters.Add("OldPassword", SqlDbType.NVarChar).Value = strOldPassword != "" ? strOldPassword : null;
                        Command.Parameters.Add("TimePasswordChange", SqlDbType.NVarChar).Value = strTimePasswordChange != "" ? strTimePasswordChange : null;
                        Command.Parameters.Add("Password1", SqlDbType.NVarChar).Value = strPassword1 != "" ? strPassword1 : null;
                        Command.Parameters.Add("Password2", SqlDbType.NVarChar).Value = strPassword2 != "" ? strPassword2 : null;
                        Command.Parameters.Add("Password3", SqlDbType.NVarChar).Value = strPassword3 != "" ? strPassword3 : null;
                        Command.Parameters.Add("Password4", SqlDbType.NVarChar).Value = strPassword4 != "" ? strPassword4 : null;
            ...
            public bool WriteOperMess_ButtSetup(uint iNButt, uint iAdrButt)
            {
                ...
                try
                {
                    ...
                    Command.Parameters.Add("NButt",SqlDbType.Int).Value = iNButt;
                    Command.Parameters.Add("AdrButt",SqlDbType.Int).Value = iAdrButt;
            ...
            public bool WriteOperMess_IDColors(uint iIdColor, string strArgbColorBg, string strNameColorBg, string strArgbColorText, string strNameColorText)
            {
                ...
                if ((strArgbColorBg != null) && (strNameColorBg != null) && (strArgbColorText != null) && (strNameColorText != null))
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("IDColor",SqlDbType.Int).Value = iIdColor;
                        Command.Parameters.Add("ARGBColorBG", SqlDbType.NVarChar).Value = strArgbColorBg;
                        Command.Parameters.Add("NameColorBG", SqlDbType.NVarChar).Value = strNameColorBg;
                        Command.Parameters.Add("ARGBColorText", SqlDbType.NVarChar).Value = strArgbColorText;
                        Command.Parameters.Add("NameColorText", SqlDbType.NVarChar).Value = strNameColorText;
            ...
            public bool WriteOperMess_IDSound(uint iIdSound, string strPathSound)
            {
                ...
                if (strPathSound != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("IDSound",SqlDbType.Int).Value = iIdSound;
                        Command.Parameters.Add("PathSound", SqlDbType.NVarChar).Value = strPathSound;
            ...
            public bool WriteOperMess_Kind(uint iKind, string strName)
            {
                ...
                if (strName != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("Kind",SqlDbType.Int).Value = iKind;
                        Command.Parameters.Add("Name", SqlDbType.NVarChar).Value = strName;
            ...
            public bool WriteOperMess_Message(uint iSysId, uint iMess, string strMessage, uint iKind, uint iPriority, uint iSound, uint iIdSound, uint iType, uint iIsAck, uint iIdColor)
            {
                ...
                if (strMessage != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("SysID",SqlDbType.Int).Value = iSysId;
                        Command.Parameters.Add("Mess",SqlDbType.Int).Value = iMess;
                        Command.Parameters.Add("Message", SqlDbType.NVarChar).Value = strMessage;
                        Command.Parameters.Add("Kind",SqlDbType.Int).Value = iKind;
                        Command.Parameters.Add("Priority",SqlDbType.Int).Value = iPriority;
                        Command.Parameters.Add("Sound",SqlDbType.Int).Value = iSound;
                        Command.Parameters.Add("IDSound",SqlDbType.Int).Value = iIdSound;
                        Command.Parameters.Add("Type",SqlDbType.Int).Value = iType;
                        Command.Parameters.Add("IsAck",SqlDbType.Int).Value = iIsAck;
                        Command.Parameters.Add("IDColor",SqlDbType.Int).Value = iIdColor;
            ...
            public bool WriteOperMess_Object(uint iSysId, uint iSysNum, string strName, int iSound1, int iSound2, int iSound3)
            {
                ...
                if (strName != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("SysID", SqlDbType.Int).Value = iSysId;
                        Command.Parameters.Add("SysNum",SqlDbType.Int).Value = iSysNum;
                        Command.Parameters.Add("Name", SqlDbType.NVarChar).Value = strName;
                        Command.Parameters.Add("Sound1",SqlDbType.Int).Value = iSound1;
                        Command.Parameters.Add("Sound2",SqlDbType.Int).Value = iSound2;
                        Command.Parameters.Add("Sound3",SqlDbType.Int).Value = iSound2;
            ...
            public bool WriteOperMess_Object(uint iSysId, uint iSysNum, string strName, int iSound1, int iSound2, int iSound3, string iSoundMes, string iSoundId, string iSound)
            {
                ...
                if (strName != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("Sound2",SqlDbType.Int).Value = iSound2;
                        Command.Parameters.Add("Sound3",SqlDbType.Int).Value = iSound2;
                        Command.Parameters.Add("SoundMES", SqlDbType.NVarChar).Value = iSoundMes;
                        Command.Parameters.Add("SoundID", SqlDbType.NVarChar).Value = iSoundId;
                        Command.Parameters.Add("Sound", SqlDbType.NVarChar).Value = iSound;
            ...
            public bool WriteOperMess_OIP(string strParamName, string strParamId, string strUnit, string strScaleBeginning, string strUst0, string strUst1, string strUst2, string strUst3, string strUst4, string strUst5, string strUst6, string strUst7, string strUst8, string strUst9, string strUst10, string strUst11, string strScaleEnd, string strHist, string strDelta, string strLimSpd, uint iAdressBeginning, uint iPlace)
            {
                    ...
                    (strLimSpd != null))
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("ParamName", SqlDbType.NVarChar).Value = strParamName;
                        Command.Parameters.Add("ParamID", SqlDbType.NVarChar).Value = strParamId;
                        Command.Parameters.Add("Unit", SqlDbType.NVarChar).Value = strUnit;
                        Command.Parameters.Add("ScaleBeginning", SqlDbType.NVarChar).Value = strScaleBeginning;
                        Command.Parameters.Add("Ust0", SqlDbType.NVarChar).Value = strUst0;
                        Command.Parameters.Add("Ust1", SqlDbType.NVarChar).Value = strUst1;
                        Command.Parameters.Add("Ust2", SqlDbType.NVarChar).Value = strUst2;
                        Command.Parameters.Add("Ust3", SqlDbType.NVarChar).Value = strUst3;
                        Command.Parameters.Add("Ust4", SqlDbType.NVarChar).Value = strUst4;
                        Command.Parameters.Add("Ust5", SqlDbType.NVarChar).Value = strUst5;
                        Command.Parameters.Add("Ust6", SqlDbType.NVarChar).Value = strUst6;
                        Command.Parameters.Add("Ust7", SqlDbType.NVarChar).Value = strUst7;
                        Command.Parameters.Add("Ust8", SqlDbType.NVarChar).Value = strUst8;
                        Command.Parameters.Add("Ust9", SqlDbType.NVarChar).Value = strUst9;
                        Command.Parameters.Add("Ust10", SqlDbType.NVarChar).Value = strUst10;
                        Command.Parameters.Add("Ust11", SqlDbType.NVarChar).Value = strUst11;
                        Command.Parameters.Add("ScaleEnd", SqlDbType.NVarChar).Value = strScaleEnd;
                        Command.Parameters.Add("Hist", SqlDbType.NVarChar).Value = strHist;
                        Command.Parameters.Add("Delta", SqlDbType.NVarChar).Value = strDelta;
                        Command.Parameters.Add("LimSpd", SqlDbType.NVarChar).Value = strLimSpd;
                        Command.Parameters.Add("AdressBeginning",SqlDbType.Int).Value = iAdressBeginning;
                        Command.Parameters.Add("Place",SqlDbType.Int).Value = iPlace;
            ...
            public bool WriteOperMess_OIP(string strParamName, string strParamId, string strUnit, string strScaleBeginning, string strUst0, string strUst1, string strUst2, string strUst3, string strUst4, string strUst5, string strUst6, string strUst7, string strUst8, string strUst9, string strUst10, string strUst11, string strScaleEnd, string strHist, string strDelta, string strLimSpd, uint iAdressBeginning, uint iPlace, uint iPlc)
            {
                ...
                if ((strParamName != null) && (strParamId != null) && (strUnit != null) && (strScaleBeginning != null) && (strUst0 != null) && (strUst1 != null) && (strUst2 != null) && (strUst3 != null) && (strUst4 != null) && (strUst5 != null) && (strUst6 != null) && (strUst7 != null) && (strUst8 != null) && (strUst9 != null) && (strUst10 != null) && (strUst11 != null) && (strScaleEnd != null) && (strHist != null) && (strDelta != null) && (strLimSpd != null))
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("AdressBeginning",SqlDbType.Int).Value = iAdressBeginning;
                        Command.Parameters.Add("Place",SqlDbType.Int).Value = iPlace;
                        Command.Parameters.Add("PLC",SqlDbType.Int).Value = iPlc;
            ...
            public bool WriteOperMess_PlaceOIP(uint iPlace, string strPlaceName)
            {
                ...
                if (strPlaceName != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("Place",SqlDbType.Int).Value = iPlace;
                        Command.Parameters.Add("PlaceName", SqlDbType.NVarChar).Value = strPlaceName;
                ...
                if ((strPlace != null) && (strDTime != null) && (strDTimeAck != null) && (strMessage != null) && (strValue != null))
                {
                    try
                    {
                        if (!string.IsNullOrEmpty(strUserName))
                        {
                            ...
                            Command.Parameters.Add("IDmess",SqlDbType.Int).Value = iIdMess;
                            Command.Parameters.Add("UserName", SqlDbType.NVarChar).Value = strUserName;
                            Command.Parameters.Add("Place", SqlDbType.NVarChar).Value = strPlace;
                            Command.Parameters.Add("DTime", SqlDbType.NVarChar).Value = strDTime;
                            Command.Parameters.Add("DTimeAck", SqlDbType.NVarChar).Value = strDTimeAck;
                            Command.Parameters.Add("SysID",SqlDbType.Int).Value = iSysId;
                            Command.Parameters.Add("SysNum",SqlDbType.Int).Value = iSysNum;
                            Command.Parameters.Add("Mess",SqlDbType.Int).Value = iMess;
                            Command.Parameters.Add("Message", SqlDbType.NVarChar).Value = strMessage;
                            Command.Parameters.Add("IsAck",SqlDbType.Int).Value = iIsAck;
                            Command.Parameters.Add("Priority",SqlDbType.Int).Value = iPriority;
                            Command.Parameters.Add("Value", SqlDbType.NVarChar).Value = strValue;
            ...
            public bool WriteOperMess_Priority(uint iPriority, string strNamePriority)
            {
                ...
                if (strNamePriority != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("Priority",SqlDbType.Int).Value = iPriority;
                        Command.Parameters.Add("NamePriority", SqlDbType.NVarChar).Value = strNamePriority;
            ...
            public bool WriteOperMess_Registration(string strLogin, string strUserName, string strUserGroup, uint iUserLevel)
            {
                ...
                if ((strLogin != null) && (strUserName != null) && (strUserGroup != null))
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("Login", SqlDbType.NVarChar).Value = strLogin;
                        Command.Parameters.Add("UserName", SqlDbType.NVarChar).Value = strUserName;
                        Command.Parameters.Add("UserGroup", SqlDbType.NVarChar).Value = strUserGroup;
                        Command.Parameters.Add("UserLevel",SqlDbType.Int).Value = iUserLevel;
            ...
            public bool WriteOperMess_SysObject(uint iSysId, string strObject, string strComment)
            {
                ...
                if ((strObject != null) && (strComment != null))
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("SysID",SqlDbType.Int).Value = iSysId;
                        Command.Parameters.Add("Object", SqlDbType.NVarChar).Value = strObject;
                        Command.Parameters.Add("Comment", SqlDbType.NVarChar).Value = strComment;
            ...
            public bool WriteOperMess_UserGroups(uint iGroupId, string strUserGroup, uint iUserLevel, uint iGroupTime, uint iIsActive)
            {
                ...
                if (strUserGroup != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("UserGroup", SqlDbType.NVarChar).Value = strUserGroup;
                        Command.Parameters.Add("UserLevel",SqlDbType.Int).Value = iUserLevel;
                        Command.Parameters.Add("GroupTime",SqlDbType.Int).Value = iGroupTime;
                        Command.Parameters.Add("isActive",SqlDbType.Int).Value = iIsActive;
            ...
            public bool WriteOperMess_UserGroups_2(uint iGroupId, string strUserGroup, uint iUserLevel, uint iGroupTime, uint iIsActive, uint iPasswordTime, uint iMinChars, uint iDayLife)
            {
                ...
                if (strUserGroup != null)
                {
                    try
                    {
                        ...
                        Command.Parameters.Add("GroupTime",SqlDbType.Int).Value = iGroupTime;
                        Command.Parameters.Add("isActive",SqlDbType.Int).Value = iIsActive;
                        Command.Parameters.Add("PasswordTime",SqlDbType.Int).Value = iPasswordTime;
                        Command.Parameters.Add("MinChars",SqlDbType.Int).Value = iMinChars;
                        Command.Parameters.Add("DayLife",SqlDbType.Int).Value = iDayLife;
